...
class Dimension {
  ...
  select (selection = []) {
    // if the current selection matches the new selection, dont do anything
    if (this.compareSelection(selection, this.selection)) return

    // otherwise apply the new selection
